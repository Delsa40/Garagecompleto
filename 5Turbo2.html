...
<body>
    ...
    <section>
        <h1 class="nombreModelo">Renault 5 Turbo 2</h1>
        <div class="fotosDe">Fotos de: @r5t2_restoration(Instagram)</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/5Turbo2.jpg"/>
                <img id="segunda" src="img/5Turbo22.jpg"/>
            </div> 
            <p id="p1">
                Velocidad máxima: 203km/h<br><br>
                0-100 km/h: 7.7s<br><br>
                Potencia máxima: 158hp<br><br>
                Longitud: 366cm<br><br>
                Anchura: 175cm<br><br>
                Altura: 132cm<br><br>
                Batalla: 243cm<br><br>
                Peso: 970kg
