...
<body>
    ...
    <section>
        <h1 class="nombreModelo">Audi RS2 Avant (1994-1995)</h1>
        <div class="fotosDe">Fotos de: @swiss_rs2(Instagram)</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/RS2Avant(1994-1995).jpg"/>
                <img id="segunda" src="img/RS2Avant(1994-1995)2.jpg"/>
            </div> 
            <p id="p1">
                Velocidad máxima: 262km/h<br><br>
                0-100 km/h: 5.4s<br><br>
                Potencia máxima: 315cv<br><br>
                Longitud: 4480mm<br><br>
                Anchura: 1695mm<br><br>
                Altura: 1410mm<br><br>
                Batalla: 2610mm<br><br>
                Peso: 1595kg
            </p>
            <p id="p2">
