<?php require('header.php') ?>
    <section>
        <h1 class="nombreModelo">Opel Astra OPC X-TREME Concept 2001</h1>
        <div class="fotosDe">Fotos de: ?</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/AstraOPCX-TREMEConcept2001.jpg"/>
                <img id="segunda" src="img/AstraOPCX-TREMEConcept20012.jpg"/>
            </div> 
            <p id="p1">
            ...
            <p id="p2">
                ...
                jaula de seguridad menos compleja que en el coche de competición. Los neumáticos han sido 
                especialmente desarrollados para este coche y tienen unas medidas de  
                265/30 delante y 305/25 detrás, mientras que los neumáticos están montados en llantas de 20 pulgadas en ambos 
                ejes.
            </p>
