...
<body>
    ...
    <section>
        <h1 class="nombreModelo">Mercedes Benz C63 AMG 2012</h1>
        <div class="fotosDe">Fotos de: @socal204, @keep_1t_300(Instagram)</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/C63AMG2012.jpg"/>
                <img id="segunda" src="img/C63AMG20122.jpg"/>
            </div> 
            <p id="p1">
                Velocidad máxima: 250km/h<br><br>
                0-100 km/h: 4.4s<br><br>
                Potencia máxima: 457cv<br><br>
                Longitud: 4707mm<br><br>
