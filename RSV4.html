...
<body>
    ...
    <section>
        <h1 class="nombreModelo">Aprilia RSV4</h1>
        <div class="fotosDe">Fotos de: @francesco_severi(Instagram)</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/RSV4.jpg"/>
                <img id="segunda" src="img/RSV42.jpg"/>
            </div> 
            <p id="p1">
                Velocidad máxima: ?<br><br>
                0-100 km/h: ?<br><br>
                Potencia máxima: 201cv<br><br>
                Longitud: 2040mm<br><br>
                Anchura: 735mm<br><br>
                Altura: 1120mm<br><br>
                Batalla: ?<br><br>
                Peso: 180kg
