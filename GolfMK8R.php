<?php require('header.php') ?>
    <section>
        <h1 class="nombreModelo">Volkswagen Golf MK8 R</h1>
        <div class="fotosDe">Fotos de: @purewhite_8r, @affiliated.media(Instagram)</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/GolfMK8R.jpg"/>
                <img id="segunda" src="img/GolfMK8R2.jpg"/>
            </div> 
            <p id="p1">
                Velocidad máxima: 250km/h/270km/h(paquete R-Performance)<br><br>
                0-100 km/h: 4.6s<br><br>
                Potencia máxima: 320cv<br><br>
                Longitud: 4290mm<br><br>
                Anchura: 1789mm<br><br>
                Altura: 1458mm<br><br>
                Batalla: 2628mm<br><br>
                Peso: 1551kg
            </p>
            <p id="p2">
