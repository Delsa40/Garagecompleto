<?php require('header.php') ?>
    <section>
        <h1 class="nombreModelo">Peugeot 206 WRC</h1>
        <div class="fotosDe">Fotos de: @sergicaz, @__rg.photography__(Instagram)</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/206WRC.jpg"/>
                <img id="segunda" src="img/206WRC2.jpg"/>
            </div> 
            <p id="p1">
                Velocidad máxima: ?<br><br>
                0-100 km/h: ?<br><br>
                Potencia máxima: 300cv<br><br>
                Longitud: 4,005m<br><br>
                Anchura: 1670mm<br><br>
                Altura: 1430mm<br><br>
                Batalla: 2,468mm<br><br>
                Peso: ?
            </p>
            <p id="p2">
