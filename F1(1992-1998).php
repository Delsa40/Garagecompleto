<?php require('header.php') ?>
    <section>
        <h1 class="nombreModelo">Mclaren F1 (1992-1998)</h1>
        <div class="fotosDe">Fotos de: @pslomoto(Instagram)</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/F1(1992-1998).jpg"/>
                <img id="segunda" src="img/F1(1992-1998)2.jpg"/>
            </div> 
            <p id="p1">
                Velocidad máxima: 386,4km/h<br><br>
                0-100 km/h: 3.2s<br><br>
                Potencia máxima: 627cv<br><br>
                Longitud: 4292mm<br><br>
                Anchura: 1820mm<br><br>
                Altura: 1140mm<br><br>
                Batalla: 2718mm<br><br>
                Peso: 1140kg
            </p>
            <p id="p2">
                ...
                automóvil de fabricación en serie con motor atmosférico más rápido del mundo.<br><br>
                ...
                manejo al conductor, además de asemejarse a la posición de manejo de un monoplaza de F1. <br><br>
                ...
                servicio al auto previniendo daños severos a cualquier componente. Aunque con respecto a las asistencias de manejo, no poseía ninguna.<br><br>
                ...
                eso F1. Su primera aparición en público fue en Mónaco el 28 de mayo de 1992. <br><br>
