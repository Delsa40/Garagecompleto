<?php require('header.php') ?>
    <section>
        <h1 class="nombreModelo">Saab 900</h1>
        <div class="fotosDe">Fotos de: @j_ust19, @janruehmke(Instagram)</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/900i8v.jpg"/>
                <img id="segunda" src="img/900i8v2.jpg"/>
            </div> 
            <p id="p1">
                Velocidad máxima: 205km/h(versión Turbo)<br><br>
                0-100 km/h: +10s<br><br>
                Potencia máxima: 160cv(versión Turbo)<br><br>
                Longitud: 4350mm<br><br>
                Anchura: 1690mm<br><br>
                Altura: 1440mm<br><br>
                Batalla: 2525mm<br><br>
                Peso: 1245kg
            </p>
            <p id="p2">
