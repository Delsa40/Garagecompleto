<?php require('header.php') ?>
    <section>
        <h1 class="nombreModelo">Alfa Romeo 8C Competizione</h1>
        <div class="fotosDe">Fotos de: @ivanorlov(Instagram)</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/8CCompetizione(2007-2010).jpg"/>
                <img id="segunda" src="img/8CCompetizione(2007-2010)2.jpg"/>
            </div> 
            <p id="p1">
                Velocidad máxima: 293km/h<br><br>
                0-100 km/h: 4.2s<br><br>
                Potencia máxima: 444hp<br><br>
                Longitud: 438.1cm<br><br>
                Anchura: 189.4cm<br><br>
                Altura: 134.1cm<br><br>
                Batalla: 269.6cm<br><br>
                Peso: 1585kg
            </p>
            <p id="p2">
