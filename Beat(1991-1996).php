<?php require('header.php') ?>
    <section>
        <h1 class="nombreModelo">Honda Beat(1991-1996)</h1>
        <div class="fotosDe">Fotos de: @byvtec(Instagram)</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/Beat(1991-1996).jpg"/>
                <img id="segunda" src="img/Beat(1991-1996)2.jpg"/>
            </div> 
            <p id="p1">
                Velocidad máxima: 135km/h<br><br>
                0-100 km/h: 12s<br><br>
                Potencia máxima: 64CV<br><br>
                Longitud: 3295mm<br><br>
                Anchura: 1395mm<br><br>
                Altura: 1280mm<br><br>
                Batalla: 2280mm<br><br>
                Peso: 760kg
            </p>
            <p id="p2">
