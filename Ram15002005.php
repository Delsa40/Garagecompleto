<?php require('header.php') ?>
    <section>
        <h1 class="nombreModelo">Dodge Ram 1500 2005</h1>
        <div class="fotosDe">Fotos de: @5.7_anthony, @photosbypacheco(Instagram)</div>
        <article class="infoDelAuto">
            <div id="contenedorDeFoto">
                <img id="primera" src="img/Ram15002005.jpg"/>
                <img id="segunda" src="img/Ram150020052.jpg"/>
            </div> 
            <p id="p1">
                Velocidad máxima: ?<br><br>
                0-100 km/h: ?<br><br>
                Potencia máxima: ?<br><br>
                Longitud: 5,27m<br><br>
                Anchura: 2,01m<br><br>
                Altura: 1,94m<br><br>
                Batalla: 3,06m<br><br>
                Peso: ?
